...
# Tenure'e (Müşterinin şirkette kaldığı ay sayısı) bakıldığında 1 aylık müşterilerin çok fazla olduğunu ardından da 72 aylık müşterilerin geldiğini görüyoruz.

df["tenure"].value_counts().head()

#  Acaba tenure Contract tipine bağlı olabilir mi?
...
# TotalCharges değişkeninde 11 tane eksik değer var. Feature engineering kısmında gerekli işlemler yapılacak.
...
# TotalChargers değişkeninin  "MonthlyCharges" ve "tenure" ile  yüksek korelasyonlu olduğu söylenebilir.
...
##################################
# NUMERİK DEĞİŞKENLER İÇİN STANDARTLAŞTIRMA
##################################
