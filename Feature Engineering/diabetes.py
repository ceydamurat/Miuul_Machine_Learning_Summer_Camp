...
##################################
# HEDEF DEĞİŞKEN ANALİZİ (Kategorik değişkenlere göre hedef değişkenin ortalaması,hedef değişkene göre numerik değişkenlerin ortalaması)
##################################
...
##################################
# Tek kategorik değişken Outcome.
...
# "NaN" değer görünmesede aslında veride eksik değerler 0 ile doldurulmuş.
# Glucos, Insulin gibi değerler 0 olamaz. Feature Engineering kısmında gerekli işlemler yapılacak.
...
# Gözlem birimlerinde 0 olan degiskenlerin her birine gidip 0 içeren gözlem degerlerini NaN ile değiştirdik.
...
print(f"Auc: {(roc_auc_score(y_pred, y_test))}")
...
# Accuracy: 0.7681647300068353

cv_results['test_precision'].mean()
# Precision: 0.713207462827028

cv_results['test_recall'].mean()
# Recall: 0.581908831908832

cv_results['test_f1'].mean()
# F1-score: 0.6372205999038542

cv_results['test_roc_auc'].mean()
# AUC: 0.8251339031339031
